    ...
    return (
        ...
        <section className={`${styles.confirmationBlock}`}>
            <svg width="60px" height="60px" viewBox="0 0 24 24" fill="none" className={`${styles.confirmationTick}`}>
                ...
                <path opacity="0.34" d="M7.75 11.9999L10.58 14.8299L16.25 9.16992" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            <h3 className={`${styles.confirmationTitle}`}>CONFIRMACION</h3>
            <p className={`${styles.confirmationText}`}>POR FAVOR CONFIRMAR TU ASISTENCIA ANTES DEL 02 DE MARZO</p>
